 ...
 *
 * @Q2 Car dans la methode add, le champs size est mise à jour. Entre le temps de lecture de la valeur size et le moment d'écriture de la nouvelle valeur, l'objet list peut avoir évolué à cause d'un autre thread. 
 * @Q3 Il peut y avoir un out-of-bounds, c'est à dire que la size devient supérieur à la taille du tableau et donc ne passe pas dans le grow. De plus, avec les optimisations de Java, il se peut que le processeur change l'ordre d'execution de certaine instruction comme 'augmenter la taille du tableau' avant de finir la copie entière du tableau.
 */
